          ...
          <v-card>
            ...
            <v-card-text>
              <v-container grid-list-md>
                <v-form
                  ref="form"
                  v-model="valid"
                  @submit.prevent="createTimelineMarketing"
                >
                  <v-layout wrap>
                    <v-flex
                      xs12
            ...
            <v-card-actions>
              ...
              <v-btn
                :disabled="!valid"
                class="bg"
                @click.exact="createTimelineMarketing"
                @click.native="dialog = false"
              >
                <v-icon left>
                  send
...
export default {
  ...
  methods: {
    ...
    createTimelineMarketing: function() {
      const payload = {
        icon: this.icon,
        color: this.color,
        title: this.title,
      ...
      this.$store.dispatch('marketing/createTimelineMarketing', payload)
      this.clear()
    }
  }
}
